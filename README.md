...
The cheapest static hosting path is GitHub Pages from the `aditya915` GitHub account. Push these files to a public repository and enable Pages for the main branch.
